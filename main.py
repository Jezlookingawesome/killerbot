...
JACKPOT_ROLE_COLOR = discord.Color.from_rgb(0, 255, 0)  # green
...
async def ensure_jackpot_role(guild):
    """Ensure the JACKPOT role exists in the guild. Returns the role or None."""
...
async def ensure_jackpot_roles_all():
    """Ensure the JACKPOT role exists in every guild the bot is in."""
